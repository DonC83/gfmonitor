...
public class JDomReader {
    ...
    public static List<BaseFeature> getNestedFeatureList(Class clazz,String xmlString, String xpath) throws JDOMException, IOException, NoSuchMethodException, InstantiationException, IllegalAccessException, Exception{
    ...
    public static List<String> getStringList(String xmlString, String xpath) throws JDOMException, IOException, NoSuchMethodException, InstantiationException, IllegalAccessException, Exception{
        ...
        XPathExpression xpathExpression = XPathFactory.instance().compile(xpath);
        List<Element> elements = xpathExpression.evaluate(document);
    ...
    public static void showResults(List<BaseFeature> allFeatures)  {
        
        for(BaseFeature feature : allFeatures){
